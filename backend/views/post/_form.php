...
<div class="col-md-4">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body w-pad">
            ...
            <?= $form->field($model, 'category')->dropDownList(\yii\helpers\ArrayHelper::map(\common\models\PostCategory::getModels(),'id','name'),['class'=>'full-width multi', 'multiple' => 'multiple']) ?>
