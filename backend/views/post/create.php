...
$this->title = Yii::t('main', 'Create Page');
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php
                            if($model->main_image && file_exists(Yii::getAlias('@frontend') . '/web/uploads/images/' . $model->id . '/m_' . $model->main_image )) {
                                ?>

                                <img class="image_preview" src="<?= Yii::$app->params['frontend'] . Yii::$app->params['uploads_url'] . $model->id . '/m_' . $model->main_image ?>"/>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body w-pad">
                            ...
                            <?= $form->field($model, 'category[]')->dropDownList(\yii\helpers\ArrayHelper::map(\common\models\PostCategory::getLangModels(),'id','name'),['class'=>'full-width multi', 'multiple' => '']) ?>
