        ...
        <div class="panel-body no-padding">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body page-header-block">
                    ...
                    <?= Html::a(Yii::t('main', 'Create Post'), ['/post/create'], ['class' => 'btn btn-success']) ?>
			    			...
			    			<?= GridView::widget([
			                    ...
			                    'columns' => [
                                    ...
                                    [
                                        'attribute' => 'category',
                                        'contentOptions' => ['class' => 'v-align-middle'],
                                        'filter' => Html::activeDropDownList($searchModel, 'category', Arrayhelper::map(\common\models\PostCategory::find()->where('status>-1')->orderBy('id')->asArray()->all(), 'id', 'name'),['class'=>'full-width', 'data-init-plugin' => 'select2','prompt' => Yii::t('main', 'Select Category')]),
                                        'content' => function($model)
                                        {
			                                ...
			                                'buttons' => function ($url, $model) {
			                                    ...
			                                    $code = <<<BUTTONS
	                                                <div class="btn-group flex-center">
	                                                    <a href="/post/update/{$model->id}" class="btn btn-complete"><i class="fa fa-pencil"></i></a>
...
BUTTONS;
                ...
                <div class="row index-footer">
                    <div class="col-md-6">
                        ...
                        <? \yii\widgets\ActiveForm::begin(['action' => '/post/index']);?>
