        ...
        <div class="panel-body no-padding">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body page-header-block">
                    ...
                    <?= Html::a(Yii::t('main', 'Create Source Message'), ['/source-message/create'], ['class' => 'btn btn-success']) ?>
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'content' => function($data){
                                        return \common\components\StaticFunctions::getPartOfText($data['message'], 30);
                                    }
                                ],
                                [
                                    'attribute' => 'O`zbekcha',
                                    'contentOptions' => ['class' => 'v-align-middle'],
                                    'content' => function($data){
                                        return StaticFunctions::getPartOfText($data['uz']['translation'], 30);
                                    }
                                ],
                                [
                                    'attribute' => 'Русский',
                                    ...
                                    'contentOptions' => ['class' => 'v-align-middle'],
                                    'content' => function($data){
                                        return StaticFunctions::getPartOfText($data['ru']['translation'], 25);
                                    }
                                ],
                                [
                                    'attribute' => 'English',
                                    'contentOptions' => ['class' => 'v-align-middle'],
                                    'content' => function($data){
                                        return StaticFunctions::getPartOfText($data['en']['translation'], 25);
                                    }
                                ],
                                [
...
BUTTONS;
                ...
                <div class="row index-footer">
                    <div class="col-md-6">
                        ...
                        <? \yii\widgets\ActiveForm::begin(['action' => '/source-message/index']);?>
